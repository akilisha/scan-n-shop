    ...
    <Layout headerContent={headerContent} showBottomNav={false}>
      <div className="space-y-6">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            <strong>Legacy Flow Deprecated:</strong> This seller registration flow has been
            replaced with a secure Stripe Connect integration. You'll be redirected automatically.
          </AlertDescription>
        </Alert>
          ...
          <CardContent className="space-y-4">
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                better security and compliance. You'll be redirected in 3 seconds.
              </p>
            </div>
